  ...
  return (
    <div className="space-y-12">
      <motion.section
        ...
        className="rounded-3xl border border-border bg-card p-10 shadow-xl transition-colors"
      >
...
npm run dev`}</code>
          ...
          <div className="w-full max-w-xs rounded-2xl border border-border bg-card p-4 text-sm transition-colors">
