...
type HomeCategoryKpisClientProps = {
  counts: DivarPostCategoryCount[];
  hasError?: boolean;
};

export function HomeCategoryKpisClient({ counts, hasError = false }: HomeCategoryKpisClientProps) {
        ...
        >
          <div className="flex h-full items-stretch">
            ...
            <div className="flex flex-1 flex-col gap-2 px-5 py-4">
              <div className="min-h-10 space-y-1 font-normal">
  ...
  }, [animated, locale, normalizedCounts, t]);
