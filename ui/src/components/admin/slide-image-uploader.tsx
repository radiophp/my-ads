...
export function SlideImageUploader({
  ...
  const t = useTranslations('admin.slides.image');
  ...
  return (
    <div className="space-y-2">
      ...
      <div
        className={cn(
          'relative flex min-h-[120px] flex-col items-center justify-center rounded-lg border border-dashed border-muted-foreground/60 bg-muted/30 p-4 text-center transition-colors',
